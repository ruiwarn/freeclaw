//! Example: Implementing a custom Memory backend for FreeClaw
//!
...
// ── Re-define the trait types (in your app, import from freeclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 FreeClaw Memory Demo — InMemoryBackend\n");
