...
const SNAPSHOT_HEADER: &str = "# 🧠 FreeClaw Memory Snapshot\n\n\
    > Auto-generated by FreeClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 FreeClaw Memory Snapshot

> Auto-generated by FreeClaw.
...
I am FreeClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 FreeClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
