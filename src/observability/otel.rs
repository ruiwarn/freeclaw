...
impl OtelObserver {
    ...
    pub fn new(endpoint: Option<&str>, service_name: Option<&str>) -> Result<Self, String> {
        ...
        let service_name = service_name.unwrap_or("freeclaw");
...
impl Observer for OtelObserver {
    fn record_event(&self, event: &ObserverEvent) {
        let tracer = global::tracer("freeclaw");
...
mod tests {
    ...
    fn test_observer() -> OtelObserver {
        ...
        OtelObserver::new(Some("http://127.0.0.1:19999"), Some("freeclaw-test"))
    ...
    fn otel_observer_creation_with_valid_endpoint_succeeds() {
        ...
        let result = OtelObserver::new(Some("http://127.0.0.1:12345"), Some("freeclaw-test"));
        assert!(
            result.is_ok(),
