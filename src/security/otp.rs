...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(freeclaw_dir);
...
pub fn secret_file_path(freeclaw_dir: &Path) -> PathBuf {
    freeclaw_dir.join(OTP_SECRET_FILE)
}
