//! Integrator — generates FreeClaw-standard SKILL.toml + SKILL.md from scout results.
...
mod tests {
    ...
    async fn integrate_creates_files() {
        let tmp = std::env::temp_dir().join("freeclaw-test-integrate");
