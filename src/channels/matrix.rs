...
impl MatrixChannel {
    ...
    pub fn new_with_session_hint(
        ...
        Self::new_with_session_hint_and_freeclaw_dir(
            homeserver,
            access_token,
            room_id,
            allowed_users,
    ...
    pub fn new_with_session_hint_and_freeclaw_dir(
        homeserver: String,
        access_token: String,
        room_id: String,
        allowed_users: Vec<String>,
...
mod tests {
    ...
    #[test]
    fn matrix_store_dir_is_derived_from_freeclaw_dir() {
        let ch = MatrixChannel::new_with_session_hint_and_freeclaw_dir(
            "https://matrix.org".to_string(),
            "tok".to_string(),
            "!r:m".to_string(),
            vec![],
            None,
            None,
            Some(PathBuf::from("/tmp/freeclaw")),
        );

        assert_eq!(
            ch.matrix_store_dir(),
            Some(PathBuf::from("/tmp/freeclaw/state/matrix"))
        );
    }

    #[test]
    fn matrix_store_dir_absent_without_freeclaw_dir() {
        let ch = MatrixChannel::new_with_session_hint(
            "https://matrix.org".to_string(),
            "tok".to_string(),
            "!r:m".to_string(),
