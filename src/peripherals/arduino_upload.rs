...
//! sketch code and calls this tool. FreeClaw compiles and uploads it — no
...
impl Tool for ArduinoUploadTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let sketch_name = "freeclaw_sketch";
        let temp_dir = std::env::temp_dir().join(format!("freeclaw_{}", uuid::Uuid::new_v4()));
