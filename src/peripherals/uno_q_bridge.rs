...
//!
//! When FreeClaw runs on Uno Q, the Bridge app (Python + MCU) exposes
...
impl Tool for UnoQGpioReadTool {
    ...
    fn description(&self) -> &str {
        "Read GPIO pin value (0 or 1) on Arduino Uno Q. Requires freeclaw-uno-q-bridge app running."
    }
...
impl Tool for UnoQGpioWriteTool {
    ...
    fn description(&self) -> &str {
        "Set GPIO pin high (1) or low (0) on Arduino Uno Q. Requires freeclaw-uno-q-bridge app running."
    }
