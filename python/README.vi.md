...
Gói Python đồng hành cho [FreeClaw](https://github.com/ruiwarn/freeclaw) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
| Tính năng | Rust FreeClaw | freeclaw-tools |
|---------|---------------|----------------|
...
Dùng **Rust FreeClaw** cho triển khai biên (edge) trong sản phẩm. Dùng **freeclaw-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
