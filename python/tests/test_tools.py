"""
Tests for freeclaw-tools package.
"""
...
def test_cli_allows_interactive_without_message():
    ...
    from freeclaw_tools.__main__ import parse_args
...
async def test_invoke_in_event_loop_raises():
    ...
    from freeclaw_tools import create_agent, shell
...
async def test_shell_tool():
    ...
    from freeclaw_tools import shell
...
async def test_file_tools(tmp_path):
    ...
    from freeclaw_tools import file_read, file_write
