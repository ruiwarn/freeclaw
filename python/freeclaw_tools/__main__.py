"""
CLI entry point for freeclaw-tools.
"""
...
DEFAULT_SYSTEM_PROMPT = """You are FreeClaw, an AI assistant with full system access. Use tools to accomplish tasks.
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="FreeClaw Tools - LangGraph-based tool calling for LLMs"
    )
    parser.add_argument(
        "message",
        nargs="*",
...
def main(argv: list[str] | None = None):
    ...
    if args.interactive:
        print("FreeClaw Tools CLI (Interactive Mode)")
