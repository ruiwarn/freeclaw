"""
Discord bot integration for FreeClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by FreeClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install freeclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"FreeClaw Discord Bot ready: {self.client.user}")
