...
SYSTEM_PROMPT = """You are FreeClaw, an AI assistant with tool access. Use tools to accomplish tasks.
...
def create_agent(
    ...
    """
    Create a FreeClaw agent with LangGraph-based tool calling.
