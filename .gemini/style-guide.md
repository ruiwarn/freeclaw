# FreeClaw Code Style Guide

This style guide provides instructions for Gemini Code Assist when reviewing pull requests for the FreeClaw project.

## Project Overview

FreeClaw is a Rust-based security-focused project that handles encryption, secrets management, and secure configuration. Code reviews should prioritize security, memory safety, and Rust best practices.
