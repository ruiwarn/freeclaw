...
```bash
# Check config
cat ~/.freeclaw/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time freeclaw channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   freeclaw daemon
   # or
   RUST_LOG=info freeclaw channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/freeclaw/issues
