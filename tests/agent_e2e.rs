...
//!
//! Ref: https://github.com/ruiwarn/freeclaw/issues/618 (item 6)

use anyhow::Result;
use async_trait::async_trait;
use freeclaw::agent::agent::Agent;
use freeclaw::agent::dispatcher::{NativeToolDispatcher, XmlToolDispatcher};
use freeclaw::agent::memory_loader::MemoryLoader;
use freeclaw::config::MemoryConfig;
use freeclaw::memory;
use freeclaw::memory::Memory;
use freeclaw::observability::{NoopObserver, Observer};
use freeclaw::providers::traits::ChatMessage;
use freeclaw::providers::{
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: freeclaw"));
...
async fn e2e_live_openai_codex_multi_turn() {
    use freeclaw::providers::openai_codex::OpenAiCodexProvider;
    use freeclaw::providers::traits::Provider;
