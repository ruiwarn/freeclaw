...
use freeclaw::providers::compatible::AuthStyle;
use freeclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use freeclaw::providers::compatible::OpenAiCompatibleProvider;
