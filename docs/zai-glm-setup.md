...
FreeClaw supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current FreeClaw provider behavior.

## Overview

FreeClaw supports these Z.AI aliases and endpoints out of the box:
...
### Test with FreeClaw CLI

```bash
# Test agent directly
echo "Hello" | freeclaw agent
