...
|---------|-----------|--------------|--------|
| **Base FreeClaw** | 3.4MB | <5MB | ✅ Current |
...
| Hardware | RAM | FreeClaw (base) | FreeClaw (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, FreeClaw uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### FreeClaw's Core Promise: Swap Anything
