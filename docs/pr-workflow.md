# FreeClaw PR Workflow (High-Volume Collaboration)

This document defines how FreeClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to FreeClaw/project-native labels.
...
- Confirm any required identity-like wording uses FreeClaw/project-native terminology.
