# Quy trình PR FreeClaw (Cộng tác khối lượng cao)

Tài liệu này định nghĩa cách FreeClaw xử lý khối lượng PR lớn trong khi vẫn duy trì:
...
- Nếu có ngôn ngữ giống danh tính trong test/ví dụ, cần được chuẩn hóa về nhãn gốc FreeClaw/dự án.
...
- Xác nhận bất kỳ ngôn ngữ giống danh tính nào đều sử dụng thuật ngữ gốc FreeClaw/dự án.
