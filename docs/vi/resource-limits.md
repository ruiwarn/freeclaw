...
## Vấn đề
FreeClaw có rate limiting (20 actions/hour) nhưng chưa có giới hạn tài nguyên. Một agent bị lỗi lặp vòng có thể:
...
Tự động tạo cgroup cho freeclaw với các giới hạn.
