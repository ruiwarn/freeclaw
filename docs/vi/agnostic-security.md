...
|---------|-----------|--------------|--------|
| **FreeClaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | FreeClaw (cơ bản) | FreeClaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, FreeClaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của FreeClaw: hoán đổi bất kỳ thứ gì
