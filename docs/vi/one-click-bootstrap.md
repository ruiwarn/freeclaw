...
Cách cài đặt và khởi tạo FreeClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài FreeClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image FreeClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.freeclaw-docker`.
