...
FreeClaw hỗ trợ các model GLM của Z.AI thông qua các endpoint tương thích OpenAI.
Hướng dẫn cấu hình thực tế theo provider hiện tại của FreeClaw.

## Tổng quan

FreeClaw hỗ trợ sẵn các alias và endpoint Z.AI sau đây:
