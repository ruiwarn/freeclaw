...
## Problem
FreeClaw has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for freeclaw with limits.
