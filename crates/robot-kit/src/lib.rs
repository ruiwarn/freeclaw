//! # FreeClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with FreeClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  FreeClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use freeclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of FreeClaw. It defines its own
//! `Tool` trait that is compatible with FreeClaw's but doesn't require it.
//!
//! ## Safety
//!
