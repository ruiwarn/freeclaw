# FreeClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for FreeClaw edge scenarios on ESP32.
...
3. Connect UI state with FreeClaw edge/runtime messaging
...
- [FreeClaw Hardware Design](../../docs/hardware-peripherals-design.md)
